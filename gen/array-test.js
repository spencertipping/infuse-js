...
infuse.assert_equal(($i([1, 2, 3]).size()           ), (3));
infuse.assert_equal((infuse.array([1, 2, 3]).size() ), (3));
infuse.assert_equal(($i === infuse                  ), (true));
...
infuse.assert_equal((ys.tos()                       ), ('#[2, 3, 4]'));
...
infuse.assert_equal((xs.tos()                       ), ('I[1, 2, 3, 5]'));
infuse.assert_equal((t.tos()                        ), ('#[... 3, 5]'));
...
infuse.assert_equal((ys2.tos()                      ), ('#[4, 6, 8, 12]'));
...
infuse.assert_equal((zs.tos()                       ), ('#[2, 3, 3, 4, 4, 5, 6, 7, 7, 8]'));

infuse.assert_equal((xs.push('foo')                 ), (xs));
infuse.assert_equal((zs.tos()                       ), ('#[2, 3, 3, 4, 4, 5, 6, 7, 7, 8, foo1, foo2]'));
...
infuse.assert_equal((all.tos()      ), ('#[1, 2, 3, 5, 6, foo, 2, 3, 3, 4, 4, 5, 6, 7, 7, 8, foo1, foo2]'));

// And like any other object, `all` will stay up to date with the objects it's
// based on:

xs.push(4);
infuse.assert_equal((all.tos()      ), ('#[1, 2, 3, 5, 6, foo, 2, 3, 3, 4, 4, 5, 6, 7, 7, 8, foo1, foo2, 4, 5, 6]'));
...
infuse.assert_equal((all.tos()      ), ('#[1, 2, 3, 5, 6, foo, 4]'));
sig.push('hi');
infuse.assert_equal((all.tos()      ), ('#[1, 2, 3, 5, 6, foo, 4, hi]'));

var o = $i({});
all = all.plus(o);

o.push('val', 'k');
infuse.assert_equal((all.tos()      ), ('#[1, 2, 3, 5, 6, foo, 4, hi, val]'));
