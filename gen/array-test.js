...
infuse.assert_equal((all.get(0)                      ), (xs.get(0)));
infuse.assert_equal((all.get(-1)                     ), (zs.get(-1)));
infuse.assert_equal((all.get().join(',')             ), (xs.get().join(',') + ',' + zs.get().join(',')));
...
xs.push(4);
infuse.assert_equal((all.size() > old_size           ), (true));
