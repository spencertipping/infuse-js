...
infuse.assert_equal((xs.get().join(',')              ), ('1,2,3,5'));
infuse.assert_equal((t.get().join(',')               ), ('3,5'));
infuse.assert_equal((t.size()                        ), (2));
...
infuse.assert_equal((all.get().join(',')    ), ('1,2,3,5,6,foo,2,3,3,4,4,5,6,7,7,8,foo1,foo2'));

// And like any other object, `all` will stay up to date with the objects it's
// based on:

xs.push(4);
infuse.assert_equal((all.get().join(',')    ), ('1,2,3,5,6,foo,2,3,3,4,4,5,6,7,7,8,foo1,foo2,4,5,6'));
...
infuse.assert_equal((all.get().join(',')     ), ('1,2,3,5,6,foo,4'));
sig.push('hi');
infuse.assert_equal((all.get().join(',')     ), ('1,2,3,5,6,foo,4,hi'));

var o = infuse({});
all = all.plus(o);

o.push('val', 'k');
infuse.assert_equal((all.get().join(',')     ), ('1,2,3,5,6,foo,4,hi,val'));
