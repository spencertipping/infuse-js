...
infuse.assert_equal((sorted.get().join(',')                  ), ('1,2,3,4'));
...
xs.push(5);
infuse.assert_equal((sorted.get().join(',')                  ), ('1,2,3,4,5'));
...
var uniqs = xs.uniq();
infuse.assert_equal((uniqs.get().join(',')                   ), ('4,3,1,2,2.1,5'));
xs.push(3).push(4).push(4);
infuse.assert_equal((uniqs.get().join(',')                   ), ('4,3,1,2,2.1,5,3,4'));
...
infuse.assert_equal((sorted_vals.get().join(',')             ), ('3,5,6'));
...
infuse.assert_equal((sorted_vals.get().join(',')             ), ('3,5,6,7,8,9'));
